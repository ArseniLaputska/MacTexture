...
@property (nonatomic, weak) NSCollectionViewFlowLayout *layout;
@end
...
- (instancetype)initWithFlowLayout:(NSCollectionViewFlowLayout *)flowLayout
{
...
- (ASSizeRange)collectionView:(ASCollectionView *)collectionView constrainedSizeForSupplementaryNodeOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
  ...
  if (ASObjectIsEqual(kind, NSCollectionElementKindSectionHeader)) {
...
#pragma clang diagnostic pop
  ...
  } else if (ASObjectIsEqual(kind, NSCollectionElementKindSectionFooter)) {
