 ...
 */
ASDK_EXTERN void ASDisplayNodeSetResizableContents(id<ASResizableContents> obj, NSImage *image);
 ...
 */
ASDK_EXTERN NSImage *ASDisplayNodeStretchableBoxContentsWithColor(NSColor *color, CGSize innerSize);
...
ASDK_EXTERN void ASDisplayNodeSetupLayerContentsWithResizableImage(CALayer *layer, NSImage *image) ASDISPLAYNODE_DEPRECATED;
