 ...
 */
@property (nullable, nonatomic) NSCollectionViewLayoutAttributes *layoutAttributes;
...
typedef NSCollectionViewItem * _Nonnull(^ASCellForItemBlock)(ASWrapperCellNode *node);
typedef NSView * _Nonnull(^ASViewForSupplementaryBlock)(ASWrapperCellNode *node);
