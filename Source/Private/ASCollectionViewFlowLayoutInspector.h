...
@property (nonatomic, weak, readonly) NSCollectionViewFlowLayout *layout;

- (instancetype)init NS_UNAVAILABLE;
- (instancetype)initWithFlowLayout:(NSCollectionViewFlowLayout *)flowLayout NS_DESIGNATED_INITIALIZER;
