...
BOOL ASDisplayShouldFetchBatchForScrollView(NSScrollView<ASBatchFetchingScrollView> *scrollView,
                                            ...
                                            BOOL flipsHorizontallyInOppositeLayoutDirection)
{
  ...
  BOOL shouldRenderRTLLayout = true/*[NSView userInterfaceLayoutDirectionForSemanticContentAttribute:scrollView.semanticContentAttribute] == NSUserInterfaceLayoutDirectionRightToLeft*/;
