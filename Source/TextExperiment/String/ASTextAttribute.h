...
APPKIT_EXTERN NSString *const ASTextBackedStringAttributeName;
...
APPKIT_EXTERN NSString *const ASTextBindingAttributeName;
...
APPKIT_EXTERN NSString *const ASTextShadowAttributeName;
...
APPKIT_EXTERN NSString *const ASTextInnerShadowAttributeName;
...
APPKIT_EXTERN NSString *const ASTextBorderAttributeName;
...
APPKIT_EXTERN NSString *const ASTextBackgroundBorderAttributeName;

/// The value of this attribute is a `ASTextBorder` object.
/// Use this attribute to add a code block border to one or more line of text.
/// The border will be drawn below the text glyphs.
APPKIT_EXTERN NSString *const ASTextBlockBorderAttributeName;
...
APPKIT_EXTERN NSString *const ASTextAttachmentAttributeName;
...
APPKIT_EXTERN NSString *const ASTextHighlightAttributeName;
...
APPKIT_EXTERN NSString *const ASTextGlyphTransformAttributeName;



#pragma mark - String Token Define

APPKIT_EXTERN NSString *const ASTextAttachmentToken; ///< Object replacement character (U+FFFC), used for text attachment.
APPKIT_EXTERN NSString *const ASTextTruncationToken; ///< Horizontal ellipsis (U+2026), used for text truncation  "…".
 ...
 */
typedef void(^ASTextAction)(NSView *containerView, NSAttributedString *text, NSRange range, CGRect rect);
...
+ (instancetype)shadowWithColor:(nullable NSColor *)color offset:(CGSize)offset radius:(CGFloat)radius NS_RETURNS_RETAINED;

@property (nullable, nonatomic) NSColor *color; ///< shadow color
...
+ (instancetype)decorationWithStyle:(ASTextLineStyle)style width:(nullable NSNumber *)width color:(nullable NSColor *)color NS_RETURNS_RETAINED;
...
@property (nullable, nonatomic) NSColor *color;        ///< line color (nil means automatic color)
...
+ (instancetype)borderWithLineStyle:(ASTextLineStyle)lineStyle lineWidth:(CGFloat)width strokeColor:(nullable NSColor *)color NS_RETURNS_RETAINED;
+ (instancetype)borderWithFillColor:(nullable NSColor *)color cornerRadius:(CGFloat)cornerRadius NS_RETURNS_RETAINED;
@property (nonatomic) ASTextLineStyle lineStyle;              ///< border line style
@property (nonatomic) CGFloat strokeWidth;                    ///< border line width
@property (nullable, nonatomic) NSColor *strokeColor; ///< border line color
@property (nonatomic) CGLineJoin lineJoin;                    ///< border line join
@property (nonatomic) NSEdgeInsets insets;                    ///< border insets for text bounds
...
@property (nullable, nonatomic) NSColor *fillColor;   ///< inner fill color
@end
...
/**
 ...
 the content will be placed in text metric. If the content is `NSImage`,
 ...
 */
+ (instancetype)highlightWithBackgroundColor:(nullable NSColor *)color NS_RETURNS_RETAINED;
...
- (void)setStrokeColor:(nullable NSColor *)color;
