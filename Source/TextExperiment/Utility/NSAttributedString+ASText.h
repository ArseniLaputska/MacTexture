 ...
 */
@property (nullable, nonatomic, readonly) NSFont *as_font;
- (nullable NSFont *)as_fontAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  ASText:6.0
 */
@property (nullable, nonatomic, readonly) NSColor *as_color;
- (nullable NSColor *)as_colorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, readonly) NSColor *as_backgroundColor;
- (nullable NSColor *)as_backgroundColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nullable, nonatomic, readonly) NSColor *as_strokeColor;
- (nullable NSColor *)as_strokeColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, readonly) NSColor *as_strikethroughColor;
- (nullable NSColor *)as_strikethroughColorAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, readonly) NSColor *as_underlineColor;
- (nullable NSColor *)as_underlineColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @param content      The attachment (NSImage/UIView/CALayer).
...
/**
 ...
 @since ASText:6.0
 */
+ (nullable NSMutableAttributedString *)as_attachmentStringWithEmojiImage:(NSImage *)image
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  ASText:6.0
 */
@property (nullable, nonatomic) NSFont *as_font;
- (void)as_setFont:(nullable NSFont *)font range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  ASText:6.0
 */
@property (nullable, nonatomic) NSColor *as_color;
- (void)as_setColor:(nullable NSColor *)color range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic) NSColor *as_backgroundColor;
- (void)as_setBackgroundColor:(nullable NSColor *)backgroundColor range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  ASText:6.0
 */
@property (nullable, nonatomic) NSColor *as_strokeColor;
- (void)as_setStrokeColor:(nullable NSColor *)strokeColor range:(NSRange)range;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic) NSColor *as_strikethroughColor;
- (void)as_setStrikethroughColor:(nullable NSColor *)strikethroughColor range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:3.2  UIKit:7.0
 */
@property (nullable, nonatomic) NSColor *as_underlineColor;
- (void)as_setUnderlineColor:(nullable NSColor *)underlineColor range:(NSRange)range;
