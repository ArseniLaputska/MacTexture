...
@property (nullable, nonatomic) NSColor *baselineColor;      ///< baseline color
@property (nullable, nonatomic) NSColor *CTFrameBorderColor; ///< CTFrame path border color
@property (nullable, nonatomic) NSColor *CTFrameFillColor;   ///< CTFrame path fill color
@property (nullable, nonatomic) NSColor *CTLineBorderColor;  ///< CTLine bounds border color
@property (nullable, nonatomic) NSColor *CTLineFillColor;    ///< CTLine bounds fill color
@property (nullable, nonatomic) NSColor *CTLineNumberColor;  ///< CTLine line number color
@property (nullable, nonatomic) NSColor *CTRunBorderColor;   ///< CTRun bounds border color
@property (nullable, nonatomic) NSColor *CTRunFillColor;     ///< CTRun bounds fill color
@property (nullable, nonatomic) NSColor *CTRunNumberColor;   ///< CTRun number color
@property (nullable, nonatomic) NSColor *CGGlyphBorderColor; ///< CGGlyph bounds border color
@property (nullable, nonatomic) NSColor *CGGlyphFillColor;   ///< CGGlyph bounds fill color
