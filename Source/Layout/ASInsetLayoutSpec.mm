...
- (instancetype)initWithInsets:(NSEdgeInsets)insets child:(id<ASLayoutElement>)child
{
  if (!(self = [super init])) {
    return nil;
  }
...
+ (instancetype)insetLayoutSpecWithInsets:(NSEdgeInsets)insets child:(id<ASLayoutElement>)child NS_RETURNS_RETAINED
{
