 ...
 */
@property (nullable) NSImage *defaultImage;
 ...
 */
- (void)imageNode:(ASNetworkImageNode *)imageNode didLoadImage:(NSImage *)image info:(ASNetworkImageLoadInfo *)info;
 ...
 * @discussion Called on the main thread if useMainThreadDelegateCallbacks=YES (the default), otherwise on a background thread.
 */
- (void)imageNode:(ASNetworkImageNode *)imageNode didLoadImage:(NSImage *)image;
