 ...
 */
@property NSEdgeInsets contentEdgeInsets;
 ...
 */
- (nullable NSAttributedString *)attributedTitleForState:(NSControlStateValue)state AS_WARN_UNUSED_RESULT;
 ...
 */
- (void)setAttributedTitle:(nullable NSAttributedString *)title forState:(NSControlStateValue)state;
 ...
 *  @param state The control state that uses the specified title.
 */
- (void)setTitle:(NSString *)title withFont:(nullable NSFont *)font withColor:(nullable NSColor *)color forState:(NSControlStateValue)state;
#endif
/**
 ...
 */
- (nullable NSImage *)imageForState:(NSControlStateValue)state AS_WARN_UNUSED_RESULT;
 ...
 *  @param state The control state that uses the specified title.
 */
- (void)setImage:(nullable NSImage *)image forState:(NSControlStateValue)state;
 ...
 *  @param state The control state that uses the specified title.
 */
- (void)setBackgroundImage:(nullable NSImage *)image forState:(NSControlStateValue)state;
 ...
 */
- (nullable NSImage *)backgroundImageForState:(NSControlStateValue)state AS_WARN_UNUSED_RESULT;
