 ...
 */
@interface ASCollectionNode : ASDisplayNode <ASRangeControllerUpdateRangeProtocol, ASRangeManagingNode, NSGestureRecognizerDelegate>
 ...
 */
@property (nonatomic) NSCollectionViewLayout *collectionViewLayout;
...
/**
 * The distance that the content view is inset from the collection node edges. Defaults to NSEdgeInsetsZero.
 */
 ...
 */
- (void)selectItemAtIndexPath:(nullable NSIndexPath *)indexPath animated:(BOOL)animated scrollPosition:(NSCollectionViewScrollPosition)scrollPosition;
 ...
 */
- (nullable NSCollectionViewItem *)cellForItemAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
- (__kindof NSCollectionViewItem *)collectionView:(NSCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath;
...
- (void)collectionView:(NSCollectionView *)collectionView willDisplayCell:(NSCollectionViewItem *)cell forItemAtIndexPath:(NSIndexPath *)indexPath;

- (void)collectionView:(NSCollectionView *)collectionView didEndDisplayingCell:(NSCollectionViewItem *)cell forItemAtIndexPath:(NSIndexPath *)indexPath;

- (void)collectionView:(NSCollectionView *)collectionView willDisplaySupplementaryView:(NSView *)view forElementKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath;

- (void)collectionView:(NSCollectionView *)collectionView didEndDisplayingSupplementaryView:(NSView *)view forElementOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath;
