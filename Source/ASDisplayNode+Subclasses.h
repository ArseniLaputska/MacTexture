...
/**
 * @summary Delegate override to provide new layer contents as a NSImage.
 *
 * @param parameters An object describing all of the properties you need to draw. Return this from
 * -drawParametersForAsyncLayer:
 * @param isCancelledBlock Execute this block to check whether the current drawing operation has been cancelled to avoid
 * unnecessary work. A return value of YES means cancel drawing and return.
 *
 * @return A NSImage with contents that are ready to display on the main thread. Make sure that the image is already
 * decoded before returning it here.
 *
 * @note Called on the display queue and/or main queue (MUST BE THREAD SAFE)
 */
+ (nullable NSImage *)displayWithParameters:(nullable id)parameters
                                isCancelled:(AS_NOESCAPE asdisplaynode_iscancelled_block_t)isCancelledBlock;
 ...
 */
- (void)touchesBeganWithEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
 ...
 * @param event A UIEvent associated with the touch.
 */
- (void)touchesMovedWithEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
 ...
 * @param event A UIEvent associated with the touch.
 */
- (void)touchesEndedWithEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
 ...
 * @param event A UIEvent associated with the touch.
 */
- (void)touchesCancelledWithEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
 ...
 * time and place where this method is called on a background thread. Note that -[NSImage imageNamed:] is not thread
 ...
 * @note Called on the display queue and/or main queue (MUST BE THREAD SAFE)
 */
- (nullable NSImage *)placeholderImage;
