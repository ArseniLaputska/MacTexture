 ...
 */
- (void)sendActionsForControlEvents:(ASControlNodeEvent)controlEvents withEvent:(nullable NSEvent *)touchEvent;
 ...
 */
- (BOOL)beginTrackingWithTouch:(NSTouch *)touch withEvent:(nullable NSEvent *)touchEvent;
 ...
 */
- (BOOL)continueTrackingWithTouch:(NSTouch *)touch withEvent:(nullable NSEvent *)touchEvent;
 ...
 */
- (void)cancelTrackingWithEvent:(nullable NSEvent *)touchEvent;
...
/**
 ...
 @param touchEvent An event object encapsulating the information specific to the user event.
 */
- (void)endTrackingWithTouch:(nullable NSTouch *)touch withEvent:(nullable NSEvent *)touchEvent;
