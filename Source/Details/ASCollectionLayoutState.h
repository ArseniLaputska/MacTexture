...
- (instancetype)initWithContext:(ASCollectionLayoutContext *)context
 ...
 elementToLayoutAttributesTable:(NSMapTable<ASCollectionElement *, NSCollectionViewLayoutAttributes *> *)table NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable NSCollectionViewLayoutAttributes *)layoutAttributesForSupplementaryElementOfKind:(NSString *)kind
 ...
 * @element The element.
 */
- (nullable NSCollectionViewLayoutAttributes *)layoutAttributesForElement:(ASCollectionElement *)element;
