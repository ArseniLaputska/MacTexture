...
typedef void(^ASImageDownloaderProgressImage)(NSImage *progressImage, CGFloat progress, id _Nullable downloadIdentifier);
 ...
 */
@property (nonatomic) void (^coverImageReadyCallback)(NSImage *coverImage);
 ...
 */
@property (nonatomic, readonly) NSImage *coverImage;
/**
