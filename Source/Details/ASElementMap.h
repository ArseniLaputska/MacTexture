...
@class ASCollectionElement, ASSection, NSCollectionViewLayoutAttributes;
 ...
 */
- (nullable ASCollectionElement *)elementForLayoutAttributes:(NSCollectionViewLayoutAttributes *)layoutAttributes;
