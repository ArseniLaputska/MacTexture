 ...
 */
typedef NSView * _Nonnull(^ASDisplayNodeViewBlock)(void);

/**
 * UIView creation block. Used to create the backing view of a new display node.
 */
typedef NSViewController * _Nonnull(^ASDisplayNodeViewControllerBlock)(void);
 ...
 * gestures on this node.  Default is NSEdgeInsetsZero.
 *
 ...
 */
@property NSEdgeInsets hitTestSlop;
 ...
 */
- (BOOL)pointInside:(CGPoint)point withEvent:(nullable NSEvent *)event AS_WARN_UNUSED_RESULT;
...
*/
@property (nullable, copy) NSColor *backgroundColor;           // default=nil

@property (null_resettable, copy) NSColor *tintColor;          // default=Blue
...
//@property            NSViewAutoresizing autoresizingMask;   // default==UIViewAutoresizingNone (undefined for layer-backed nodes)
 ...
 */
@property           NSEdgeInsets layoutMargins;
...
@property (nullable, copy)   NSAttributedString *accessibilityAttributedLabel;
@property (nullable, copy)   NSString *accessibilityHint;
@property (nullable, copy)   NSAttributedString *accessibilityAttributedHint;
@property (nullable, copy)   NSString *accessibilityValue;
@property (nullable, copy)   NSAttributedString *accessibilityAttributedValue;
//@property           UIAccessibilityTraits accessibilityTraits;
@property           CGRect accessibilityFrame;
@property (nullable, copy)   NSBezierPath *accessibilityPath;
...
@property (nullable, copy)   NSArray *accessibilityCustomActions;
