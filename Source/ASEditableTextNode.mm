...
- (BOOL)gestureRecognizerShouldBegin:(NSGestureRecognizer *)gestureRecognizer
{
  ...
  if (_shouldBlockPanGesture && gestureRecognizer == self.gestureRecognizers.firstObject)
    return NO;

  // Otherwise, proceed as usual.
//  if ([NSTextView instancesRespondToSelector:_cmd])
...
- (void)didLoad
{
  ...
  void (^configureTextView)(NSTextView *) = ^(NSTextView *textView) {
...
- (void)textViewDidChangeSelection:(NSTextView *)textView
{
...
- (void)textViewDidEndEditing:(NSTextView *)textView
{
  // Delegateify.
...
- (NSUInteger)layoutManager:(NSLayoutManager *)layoutManager shouldGenerateGlyphs:(const CGGlyph *)glyphs properties:(const NSGlyphProperty *)properties characterIndexes:(const NSUInteger *)characterIndexes font:(NSFont *)aFont forGlyphRange:(NSRange)glyphRange
{
