 ...
 */
@property (nullable, copy, readonly) NSCollectionViewLayoutAttributes *layoutAttributes;
 ...
 */
@property (nullable, nonatomic, readonly) NSViewController *viewController;
 ...
 */
- (void)touchesBegan:(NSSet<NSTouch *> *)touches withEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
- (void)touchesMoved:(NSSet<NSTouch *> *)touches withEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
- (void)touchesEnded:(NSSet<NSTouch *> *)touches withEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
- (void)touchesCancelled:(nullable NSSet<NSTouch *> *)touches withEvent:(nullable NSEvent *)event ASDISPLAYNODE_REQUIRES_SUPER;
 ...
 */
- (void)cellNodeVisibilityEvent:(ASCellNodeVisibilityEvent)event inScrollView:(nullable NSScrollView *)scrollView withCellFrame:(CGRect)cellFrame;
 ...
 */
@property NSTableViewSelectionHighlightStyle selectionStyle;

/* @abstract The focus style when a cell is focused
 * @default UITableViewCellFocusStyleDefault
 * ASTableView uses these properties when configuring UITableViewCells that host ASCellNodes.
 */
//@property NSTableViewCellFocusStyle focusStyle;
 ...
 */
@property (nullable) NSView *selectedBackgroundView;

/* @abstract The view used as the background of the cell.
 * ASTableView uses these properties when configuring UITableViewCells that host ASCellNodes.
 * ASCollectionView uses these properties when configuring UICollectionViewCells that host ASCellNodes.
 */
@property (nullable) NSView *backgroundView;
 ...
 * ASTableView uses these properties when configuring UITableViewCells that host ASCellNodes.
 */
@property NSEdgeInsets separatorInset;
 ...
 */
@property NSEdgeInsets textInsets;
