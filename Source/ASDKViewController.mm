...
@implementation ASDKViewController
{
  ...
  NSEdgeInsets _fallbackAdditionalSafeAreaInsets;
}
...
- (void)_initializeInstance
{
  ...
  _fallbackAdditionalSafeAreaInsets = NSEdgeInsetsZero;
...
//  ASPrimitiveTraitCollection traitCollection = [self primitiveTraitCollectionForUITraitCollection:ASPrimitiveTraitCollectionMakeDefault()];
...
{
  NSEdgeInsets safeArea = NSEdgeInsetsMake(0, 0, 0, 0);
  NSEdgeInsets additionalInsets = self.additionalSafeAreaInsets;
...
- (NSEdgeInsets)additionalSafeAreaInsets
{
  return NSEdgeInsets();
}

- (void)setAdditionalSafeAreaInsets:(NSEdgeInsets)additionalSafeAreaInsets
{
...
//- (void)didRotateFromInterfaceOrientation:(NSInterfaceO)fromInterfaceOrientation
//{
