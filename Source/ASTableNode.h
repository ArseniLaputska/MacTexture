...
- (instancetype)initWithStyle:(NSTableViewStyle)style NS_DESIGNATED_INITIALIZER;
...
/**
 * The distance that the content view is inset from the table node edges. Defaults to NSEdgeInsetsZero.
 */
 ...
 *
 * @param row The index path of the row.
 *
 ...
 * @discussion This method must be called from the main thread.
 */
- (nullable __kindof NSTableCellView *)cellForRowAtIndexPath:(NSIndexPath *)indexPath AS_WARN_UNUSED_RESULT;
