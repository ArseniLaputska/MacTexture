...
@property (nonatomic, copy, readonly) NSColor *shadowColor;
 ...
 *  NSEdgeInsets shadowPadding = [shadower shadowPadding];
 *  CGRect boundsWithShadowPadding = NSEdgeInsetsRect(boundsWithoutShadowPadding, shadowPadding);
 */
