 ...
 *
 * @discussion ASMultiplexImageNode begins loading images when its resource can either return a NSImage directly, or a URL the image node should load.
 */
...
/**
 * @abstract Notify the receiver SSAA that its data source has new NSImages or NSURLs available for <imageIdentifiers>.
 *
 ...
 */
- (void)multiplexImageNode:(ASMultiplexImageNode *)imageNode
            didUpdateImage:(nullable NSImage *)image
            withIdentifier:(nullable ASImageIdentifier)imageIdentifier
                 fromImage:(nullable NSImage *)previousImage
 ...
 */
- (void)multiplexImageNode:(ASMultiplexImageNode *)imageNode
    didDisplayUpdatedImage:(nullable NSImage *)image
            withIdentifier:(nullable ASImageIdentifier)imageIdentifier;
 ...
 * @return A NSImage corresponding to `imageIdentifier`, or nil if none is available.
 */
- (nullable NSImage *)multiplexImageNode:(ASMultiplexImageNode *)imageNode imageForImageIdentifier:(ASImageIdentifier)imageIdentifier;
