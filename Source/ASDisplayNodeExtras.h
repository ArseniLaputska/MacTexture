 ...
 */
ASDK_EXTERN ASInterfaceState ASInterfaceStateForDisplayNode(ASDisplayNode *displayNode, NSWindow *window) AS_WARN_UNUSED_RESULT;
 ...
 */
ASDK_EXTERN ASDisplayNode * _Nullable ASViewToDisplayNode(NSView * _Nullable view) AS_WARN_UNUSED_RESULT;
 ...
 */
ASDK_EXTERN NSWindow * _Nullable ASFindWindowOfLayer(CALayer *layer) AS_WARN_UNUSED_RESULT;

/**
 * Given a layer, find the closest view it lives in, if any.
 */
ASDK_EXTERN NSView * _Nullable ASFindClosestViewOfLayer(CALayer *layer) AS_WARN_UNUSED_RESULT;
...
ASDK_EXTERN NSColor *ASDisplayNodeDefaultPlaceholderColor(void) AS_WARN_UNUSED_RESULT;
ASDK_EXTERN NSColor *ASDisplayNodeDefaultTintColor(void) AS_WARN_UNUSED_RESULT;
