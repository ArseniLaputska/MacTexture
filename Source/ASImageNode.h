 ...
 */
typedef NSImage * _Nullable (^asimagenode_modification_block_t)(NSImage *image, ASPrimitiveTraitCollection traitCollection);
 ...
 */
@property (nullable, copy) NSColor *placeholderColor;
 ...
 */
ASDK_EXTERN asimagenode_modification_block_t ASImageNodeRoundBorderModificationBlock(CGFloat borderWidth, NSColor * _Nullable borderColor);

/**
 * @abstract Image modification block that applies a tint color à la NSImage configured with
 * renderingMode set to NSImageRenderingModeAlwaysTemplate.
 *
 ...
 * @return An ASImageNode image modification block.
 */
ASDK_EXTERN asimagenode_modification_block_t ASImageNodeTintColorModificationBlock(NSColor *color);
