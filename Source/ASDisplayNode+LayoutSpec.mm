...
//  BOOL shouldRenderRTLLayout = [NSView userInterfaceLayoutDirectionForSemanticContentAttribute:_semanticContentAttribute] == NSUserInterfaceLayoutDirectionRightToLeft;
//  if (shouldRenderRTLLayout) {
//      for (ASLayout *sublayout in layout.sublayouts) {
//          switch (_semanticContentAttribute) {
//              case NSViewSemanticContentAttributeUnspecified:
//              case NSViewSemanticContentAttributeForceRightToLeft: {
//                  // Отражение позиции
...
//                  break; // Добавлен break для предотвращения "проваливания" в следующий кейс
//              }
//              case NSViewSemanticContentAttributePlayback:
//              case NSViewSemanticContentAttributeForceLeftToRight:
//              case NSViewSemanticContentAttributeSpatial:
//                  // Не отражать
//                  break;
//          }
//      }
